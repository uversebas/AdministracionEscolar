...
export class PaymentConcept{
    constructor(public title:string, public amount:number, public stageChoolId:number, public status:string, public isOption:boolean,public dues:boolean ,  public id?:number, public checked?:boolean){}
